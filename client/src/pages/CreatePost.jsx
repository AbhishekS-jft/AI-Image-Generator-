...
const CreatePost = () => {
    ...
    const generateImage=async()=>{
        ...
        {
            alert("Please Enter a Prompt or click Surprise Me to generate an Image")
        }
  ...
  return (
    ...
    <div>
        ...
        <p className="mt-2 text-[#666e75] text-[15px] max-w[500px]">
            Create imaginative and Visually Stunning Images throgh AI and also share them with Community
        </p>
    </div> 
